...
This file lists the Spanish vocabulary items explored for mnemonic generation and briefly describes the mnemonic logic behind each stimulus.
...
- **Mnemonic idea:** The image links *pan* to bread placed on a frying pan. 
- **Image file:** `pan.png`
...
- **Mnemonic idea:** The image links *libro* to *library* by showing a book walking toward a library. 
- **Image file:** `libro.png`
...
- **Mnemonic idea:** The image links *escuela* to *queue* by showing children queueing in front of a school. 
- **Image file:** `escuela.png`
